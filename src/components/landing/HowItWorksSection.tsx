          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((step, index) => (
              ...
              >
                {/* Card */}
                <motion.div 
                  className="relative bg-card/50 backdrop-blur-sm rounded-2xl border border-border/50 p-6 h-full hover:border-primary/20 hover:shadow-xl hover:shadow-primary/5 transition-all duration-500"
                  whileHover={{ y: -8 }}
                >
                  {/* Number Badge */}
                  <motion.div 
                    className={`absolute -top-4 left-6 px-4 py-1.5 rounded-full bg-gradient-to-r ${step.color} text-white text-sm font-bold shadow-lg`}
                  ...
                  <div className="mt-6">
                    {/* Icon */}
                    <motion.div 
                      className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${step.color} bg-opacity-10 flex items-center justify-center mb-5 relative`}
                      style={{ 
